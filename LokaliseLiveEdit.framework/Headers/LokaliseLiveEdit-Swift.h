...
#ifndef LOKALISELIVEEDIT_SWIFT_H
#define LOKALISELIVEEDIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LokaliseLiveEdit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


typedef SWIFT_ENUM(NSInteger, LiveModeState, closed) {
...
SWIFT_PROTOCOL("_TtP16LokaliseLiveEdit39LokaliseDisplayedViewControllerProvider_")
@protocol LokaliseDisplayedViewControllerProvider <NSObject>
...
- (NSArray<NSString *> * _Nonnull)localizableKeys SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface UINavigationController (SWIFT_EXTENSION(LokaliseLiveEdit)) <LokaliseDisplayedViewControllerProvider>
- (UIViewController * _Nullable)displayedViewController SWIFT_WARN_UNUSED_RESULT;
@end


@interface UITabBarController (SWIFT_EXTENSION(LokaliseLiveEdit)) <LokaliseDisplayedViewControllerProvider>
- (UIViewController * _Nullable)displayedViewController SWIFT_WARN_UNUSED_RESULT;
@end
