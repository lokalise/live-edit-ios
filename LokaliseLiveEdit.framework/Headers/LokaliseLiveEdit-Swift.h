...
SWIFT_CLASS("_TtC16LokaliseLiveEdit16LokaliseLiveEdit")
@interface LokaliseLiveEdit : NSObject
...
@interface NSArray (SWIFT_EXTENSION(LokaliseLiveEdit))
@end


@interface NSData (SWIFT_EXTENSION(LokaliseLiveEdit))
@end


@interface NSDictionary (SWIFT_EXTENSION(LokaliseLiveEdit))
@end
...
@interface NSLayoutConstraint (SWIFT_EXTENSION(LokaliseLiveEdit))
@end


@interface NSNull (SWIFT_EXTENSION(LokaliseLiveEdit))
@end


@interface NSString (SWIFT_EXTENSION(LokaliseLiveEdit))
@end
...
///
/// \endcode
SWIFT_CLASS("_TtC16LokaliseLiveEdit13OnAckCallback")
...
SWIFT_CLASS("_TtC16LokaliseLiveEdit7SSLCert")
...
SWIFT_CLASS("_TtC16LokaliseLiveEdit16SocketAckEmitter")
...
SWIFT_CLASS("_TtC16LokaliseLiveEdit14SocketAnyEvent")
...
///
/// \endcode
SWIFT_CLASS("_TtC16LokaliseLiveEdit19SocketClientManager")
...
SWIFT_CLASS("_TtC16LokaliseLiveEdit12SocketEngine")
...
@interface SocketEngine (SWIFT_EXTENSION(LokaliseLiveEdit))
...
SWIFT_PROTOCOL("_TtP16LokaliseLiveEdit18SocketEngineClient_")
@protocol SocketEngineClient
...
SWIFT_PROTOCOL("_TtP16LokaliseLiveEdit16SocketEngineSpec_")
...
SWIFT_CLASS("_TtC16LokaliseLiveEdit14SocketIOClient")
...
@interface UIApplication (SWIFT_EXTENSION(LokaliseLiveEdit))
@end


@interface UIImage (SWIFT_EXTENSION(LokaliseLiveEdit))
@end


@interface UILabel (SWIFT_EXTENSION(LokaliseLiveEdit))
@end


@interface UITextField (SWIFT_EXTENSION(LokaliseLiveEdit))
@end


@interface UITextView (SWIFT_EXTENSION(LokaliseLiveEdit))
@end


@interface UIView (SWIFT_EXTENSION(LokaliseLiveEdit))
@end

@class UIEvent;

@interface UIViewController (SWIFT_EXTENSION(LokaliseLiveEdit))
- (void)motionEnded:(UIEventSubtype)motion withEvent:(UIEvent * _Nullable)event;
@end

@class NSStream;

SWIFT_CLASS("_TtC16LokaliseLiveEdit9WebSocket")
